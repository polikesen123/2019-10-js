...
var Zepto = function () {
    ...
    function P(a) {
        return a.replace(/::/g, "/").replace(/([A-Z]+)([A-Z][a-z])/g, "$1_$2").replace(/([a-z\d])([A-Z])/g, "$1_$2")
    ...
    function S(a) {
        var b, c;
        return i[a] || (b = h.createElement(a), h.body.appendChild(b), c = getComputedStyle(b, "").getPropertyValue(
            "display"), b.parentNode.removeChild(b), c == "none" && (c = "block"), i[a] = c), i[a]
    }
    ...
    function U(c, d, e) {
        for (b in d) e && (K(d[b]) || L(d[b])) ? (K(d[b]) && !K(c[b]) && (c[b] = {}), L(d[b]) && !L(c[b]) && (c[b] = []),
    ...
    function Z(a) {
        var b;
        try {
            return a ? a == "true" || (a == "false" ? !1 : a == "null" ? null : !/^0/.test(a) && !isNaN(b = Number(
                a)) ? b : /^[\[\{]/.test(a) ? c.parseJSON(a) : a) : a
        } catch (d) {
            return a
        }
    }
    ...
    function $(a, b) {
        b(a);
        for (var c in a.childNodes) $(a.childNodes[c], b)
    }
    var a, b, c, d, e = [],
        f = e.slice,
        g = e.filter,
    ...
    return A.matches = function (a, b) {
            ...
            var g, i, j;
            return m.test(b) && (g = c(h.createElement(RegExp.$1))), g || (b.replace && (b = b.replace(n,
                    "<$1></$2>")), d === a && (d = l.test(b) && RegExp.$1), d in t || (d = "*"), j = t[d], j.innerHTML =
                "" + b, g = c.each(f.call(j.childNodes), function () {
                    j.removeChild(this)
            ...
            if (typeof b == "string") {
                b = b.trim();
                if (b[0] == "<" && l.test(b)) e = A.fragment(b, RegExp.$1, d), b = null;
                else {
                ...
                else if (l.test(b)) e = A.fragment(b.trim(), RegExp.$1, d), b = null;
                else {
                    if (d !== a) return c(d).find(b);
                    e = A.qsa(h, b)
                }
            ...
            var c, d = b[0] == "#",
                ...
                g = d || e ? b.slice(1) : b,
                h = x.test(g);
            return I(a) && h && d ? (c = a.getElementById(g)) ? [c] : [] : a.nodeType !== 1 && a.nodeType !== 9 ? [] :
                f.call(h && !d ? e ? a.getElementsByClassName(g) : a.getElementsByTagName(b) : a.querySelectorAll(b))
        }, c.contains = function (a, b) {
            return a !== b && a.contains(b)
        }, c.type = F, c.isFunction = G, c.isWindow = H, c.isArray = L, c.isPlainObject = K, c.isEmptyObject =
        function (a) {
            var b;
            for (b in a) return !1;
            return !0
            ...
            return g.call(a, b)
        }, window.JSON && (c.parseJSON = JSON.parse), c.each(
            ...
            closest: function (a, b) {
                ...
                while (d && !(e ? e.indexOf(d) >= 0 : A.matches(d, a))) d = d !== b && !I(d) && d.parentNode;
                return c(d)
            },
            parents: function (a) {
                var b = [],
                ...
                while (d.length > 0) d = c.map(d, function (a) {
                    if ((a = a.parentNode) && !I(a) && b.indexOf(a) < 0) return b.push(a), a
                });
                return V(b, a)
            },
            parent: function (a) {
            ...
            show: function () {
                return this.each(function () {
                    this.style.display == "none" && (this.style.display = ""), getComputedStyle(this,
                        "").getPropertyValue("display") == "none" && (this.style.display = S(this.nodeName))
                })
            },
            ...
            html: function (a) {
                return arguments.length === 0 ? this.length > 0 ? this[0].innerHTML : null : this.each(function (
                    b) {
            ...
            text: function (b) {
                return arguments.length === 0 ? this.length > 0 ? this[0].textContent : null : this.each(
                    function () {
            ...
            attr: function (c, d) {
                var e;
                return typeof c == "string" && d === a ? this.length == 0 || this[0].nodeType !== 1 ? a : c ==
                    "value" && this[0].nodeName == "INPUT" ? this.val() : !(e = this[0].getAttribute(c)) && c in
                    this[0] ? this[0][c] : e : this.each(function (a) {
                        if (this.nodeType !== 1) return;
                        if (J(c))
                            for (b in c) X(this, b, c[b]);
            ...
            prop: function (b, c) {
                return b = E[b] || b, c === a ? this[0] && this[0][b] : this.each(function (a) {
            ...
            val: function (a) {
                return arguments.length === 0 ? this[0] && (this[0].multiple ? c(this[0]).find("option").filter(
                    function () {
            ...
            css: function (a, d) {
                if (arguments.length < 2) {
                    ...
                    if (!e) return;
                    if (typeof a == "string") return e.style[B(a)] || f.getPropertyValue(a);
                    if (L(a)) {
                        var g = {};
                ...
                var h = "";
                if (F(a) == "string") !d && d !== 0 ? this.each(function () {
            ...
            position: function () {
                ...
                return d.top -= parseFloat(c(a).css("margin-top")) || 0, d.left -= parseFloat(c(a).css(
                        "margin-left")) || 0, e.top += parseFloat(c(b[0]).css("border-top-width")) || 0, e.left +=
                    parseFloat(c(b[0]).css("border-left-width")) || 0, {
                        top: d.top - e.top,
                        left: d.left - e.left
                    }
            },
            ...
            c.fn[b] = function (e) {
                var f, g = this[0];
                return e === a ? H(g) ? g["inner" + d] : I(g) ? g.documentElement["scroll" + d] : (f = this
                    .offset()) && f[b] : this.each(function (a) {
            ...
            c.fn[a] = function () {
                var a, e = c.map(arguments, function (b) {
                        return a = F(b), a == "object" || a == "array" || b == null ? b : A.fragment(b)
                    }),
                    f, g = this.length > 1;
                return e.length < 1 ? this : this.each(function (a, h) {
                    f = d ? h : h.parentNode, h = b == 0 ? h.nextSibling : b == 1 ? h.firstChild :
                        b == 2 ? h : null, e.forEach(function (a) {
                            if (g) a = a.cloneNode(!0);
                            else if (!f) return c(a).remove();
                            $(f.insertBefore(a, h), function (a) {
                                a.nodeName != null && a.nodeName.toUpperCase() ===
                                    "SCRIPT" && (!a.type || a.type ===
                                        "text/javascript") && !a.src && window.eval.call(
                                        window, a.innerHTML)
                            })
                        })
                })
        ...
        }), A.Z.prototype = c.fn, A.uniq = C, A.deserializeValue = Z, c.zepto = A, c
}();
window.Zepto = Zepto, window.$ === undefined && (window.$ = Zepto),
    ...
    function (a) {
        ...
        function l(a, b, c, d) {
            b = m(b);
            if (b.ns) var e = n(b.ns);
            return (h[k(a)] || []).filter(function (a) {
                return a && (!b.e || a.e == b.e) && (!b.ns || e.test(a.ns)) && (!c || k(a.fn) === k(c)) && (!d ||
                    a.sel == d)
            })
        }
        ...
        function q(b, c, e, f, g, i, l) {
            ...
            c.split(/\s/).forEach(function (c) {
                ...
                var h = m(c);
                h.fn = e, h.sel = g, h.e in j && (e = function (b) {
                ...
                }, h.i = q.length, q.push(h), "addEventListener" in b && b.addEventListener(p(h.e), h.proxy,
                    o(h, l))
            })
        }
        ...
        function r(a, b, c, d, e) {
            ...
            (b || "").split(/\s/).forEach(function (b) {
                l(a, b, c, d).forEach(function (b) {
                    delete h[f][b.i], "removeEventListener" in a && a.removeEventListener(p(b.e), b.proxy,
                        o(b, e))
                })
            })
        }
        ...
        function w(b, c) {
            if (c || !b.isDefaultPrevented) {
                c || (c = b), a.each(v, function (a, d) {
                    var e = c[a];
                    b[a] = function () {
                        return this[d] = s, e && e.apply(c, arguments)
                    }, b[d] = t
                });
                if (c.defaultPrevented !== d ? c.defaultPrevented : c.getPreventDefault && c.getPreventDefault()) b.isDefaultPrevented =
                    s
            }
            return b
        }
        ...
        function x(a) {
            ...
            for (b in a) !u.test(b) && a[b] !== d && (c[b] = a[b]);
            return w(c, a)
        }
        var b = a.zepto.qsa,
            c = 1,
        ...
        a.fn.delegate = function (a, b, c) {
                ...
                return b && !g(b) ? (a.each(b, function (a, b) {
                    m.on(a, c, h, b, j)
                }), m) : (!g(c) && !f(i) && (i = h, h = c, c = d), f(h) && (i = h, h = d), m.each(function (d, f) {
                    j && (k = function (a) {
                        return r(f, a.type, i), i.apply(this, arguments)
                    }), c && (l = function (b) {
                        var d, g = a(b.target).closest(c, f).get(0);
                        if (g) return d = a.extend(x(b), {
                            currentTarget: g,
                            liveFired: f
                ...
                return b && !g(b) ? (a.each(b, function (a, b) {
                    h.off(a, c, b)
                }), h) : (!g(c) && !f(e) && (e = c, c = d), h.each(function () {
                    r(this, b, e, c)
                }))
            }, a.fn.trigger = function (b, c) {
                return b = g(b) || a.isPlainObject(b) ? a.Event(b) : w(b), b._args = c, this.each(function () {
                ...
                return this.each(function (f, h) {
                    d = x(g(b) ? a.Event(b) : b), d._args = c, d.target = h, a.each(l(h, b.type || b), function (
                        a, b) {
                        e = b.proxy(d);
    ...
    function ($) {
        ...
        function ajaxError(a, b, c, d) {
            var e = d.context;
            d.error.call(e, c, b, a), triggerGlobal(d, e, "ajaxError", [c, d, a || b]), ajaxComplete(b, c, d)
        }
        ...
        function mimeToDataType(a) {
            return a && (a = a.split(";", 2)[0]), a && (a == htmlType ? "html" : a == jsonType ? "json" : scriptTypeRE.test(
                a) ? "script" : xmlTypeRE.test(a) && "xml") || "text"
        }
        ...
        function serializeData(a) {
            a.processData && a.data && $.type(a.data) != "string" && (a.data = $.param(a.data, a.traditional)), a.data &&
                (!a.type || a.type.toUpperCase() == "GET") && (a.url = appendQuery(a.url, a.data), a.data = null)
        }
        ...
        function serialize(a, b, c, d) {
            var e, f = $.isArray(b),
                g = $.isPlainObject(b);
            $.each(b, function (b, h) {
                e = $.type(h), d && (b = c ? d : d + "[" + (g || e == "object" || e == "array" ? b : "") + "]"),
                    !d && f ? a.add(h.name, h.value) : e == "array" || !c && e == "object" ? serialize(a, h, c,
                        b) : a.add(b, h)
            })
        }
        var jsonpID = 0,
        ...
        $.active = 0, $.ajaxJSONP = function (a) {
            if ("type" in a) {
                var b = a.jsonpCallback,
                    c = ($.isFunction(b) ? b() : b) || "jsonp" + ++jsonpID,
                ...
                return $(d).on("load error", function (b, g) {
                    clearTimeout(i), $(d).off().remove(), b.type == "error" || !f ? ajaxError(null, g ||
                            "error", h, a) : ajaxSuccess(f[0], h, a), window[c] = e, f && $.isFunction(e) &&
                        e(f[0]), e = f = undefined
                }), ajaxBeforeSend(h, a) === !1 ? (g("abort"), !1) : (window[c] = function () {
                    f = arguments
                }, d.src = a.url.replace(/=\?/, "=" + c), document.head.appendChild(d), a.timeout > 0 && (i =
                    setTimeout(function () {
                        g("timeout")
                    }, a.timeout)), h)
            }
            ...
            ajaxStart(settings), settings.crossDomain || (settings.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(
                settings.url) && RegExp.$2 != window.location.host), settings.url || (settings.url = window.location
                .toString()), serializeData(settings), settings.cache === !1 && (settings.url = appendQuery(
                settings.url, "_=" + Date.now()));
            var dataType = settings.dataType,
                hasPlaceholder = /=\?/.test(settings.url);
            if (dataType == "jsonp" || hasPlaceholder) return hasPlaceholder || (settings.url = appendQuery(
                settings.url, settings.jsonp ? settings.jsonp + "=?" : settings.jsonp === !1 ? "" :
                "callback=?")), $.ajaxJSONP(settings);
            var mime = settings.accepts[dataType],
                baseHeaders = {},
                protocol = /^([\w-]+:)\/\//.test(settings.url) ? RegExp.$1 : window.location.protocol,
                xhr = settings.xhr(),
                abortTimeout;
            settings.crossDomain || (baseHeaders["X-Requested-With"] = "XMLHttpRequest"), baseHeaders.Accept = mime ||
                "*/*";
            if (mime = settings.mimeType || mime) mime.indexOf(",") > -1 && (mime = mime.split(",", 2)[0]), xhr.overrideMimeType &&
                xhr.overrideMimeType(mime);
            if (settings.contentType || settings.contentType !== !1 && settings.data && settings.type.toUpperCase() !=
                "GET") baseHeaders["Content-Type"] = settings.contentType || "application/x-www-form-urlencoded";
                ...
                if (xhr.readyState == 4) {
                    ...
                    if (xhr.status >= 200 && xhr.status < 300 || xhr.status == 304 || xhr.status == 0 &&
                        ...
                        dataType = dataType || mimeToDataType(settings.mimeType || xhr.getResponseHeader(
                            "content-type")), result = xhr.responseText;
                        try {
                            dataType == "script" ? (1, eval)(result) : dataType == "xml" ? result = xhr.responseXML :
                                dataType == "json" && (result = blankRE.test(result) ? null : $.parseJSON(
                                    result))
                        } catch (e) {
                            error = e
                        }
                        error ? ajaxError(error, "parsererror", xhr, settings) : ajaxSuccess(result, xhr,
                            settings)
                    } else ajaxError(xhr.statusText || null, xhr.status ? "error" : "abort", xhr, settings)
                }
            };
            if (ajaxBeforeSend(xhr, settings) === !1) return xhr.abort(), !1;
    ...
    function (a) {
        function b(a) {
            ...
            e && (b.android = !0, b.version = e[2]), h && !g && (b.ios = b.iphone = !0, b.version = h[2].replace(/_/g,
                    ".")), f && (b.ios = b.ipad = !0, b.version = f[2].replace(/_/g, ".")), g && (b.ios = b.ipod = !0,
                    b.version = g[3] ? g[3].replace(/_/g, ".") : null), i && (b.webos = !0, b.version = i[2]), j && (b.touchpad = !
                    0), m && (b.blackberry = !0, b.version = m[2]), n && (b.bb10 = !0, b.version = n[2]), o && (b.rimtabletos = !
                    0, b.version = o[2]), p && (c.playbook = !0), k && (b.kindle = !0, b.version = k[1]), l && (c.silk = !
                    0, c.version = l[1]), !l && b.android && a.match(/Kindle Fire/) && (c.silk = !0), q && (c.chrome = !
                    0, c.version = q[1]), r && (c.firefox = !0, c.version = r[1]), s && (c.ie = !0, c.version = s[1]),
                t && (a.match(/Safari/) || !!b.ios) && (c.safari = !0), u && (c.webview = !0), s && (c.ie = !0, c.version =
                    s[1]), b.tablet = !!(f || p || e && !a.match(/Mobile/) || r && a.match(/Tablet/) || s && !a.match(
                    /Phone/) && a.match(/Touch/)), b.phone = !!(!b.tablet && !b.ipod && (e || h || i || m || n || q &&
                    a.match(/Android/) || q && a.match(/CriOS\/([\d.]+)/) || r && a.match(/Mobile/) || s && a.match(
                        /Touch/)))
        }
    ...
    function (a, b) {
        ...
        a.each(g, function (a, e) {
            if (i.style[a + "TransitionProperty"] !== b) return c = "-" + a.toLowerCase() + "-", d = e, !1
        }), k = c + "transform", t[l = c + "transition-property"] = t[m = c + "transition-duration"] = t[o = c +
            "transition-delay"] = t[n = c + "transition-timing-function"] = t[p = c + "animation-name"] = t[q = c +
            "animation-duration"] = t[s = c + "animation-delay"] = t[r = c + "animation-timing-function"] = "", a.fx = {
            ...
            return a.isFunction(d) && (f = d, e = b, d = b), a.isFunction(e) && (f = e, e = b), a.isPlainObject(d) &&
                (e = d.easing, f = d.complete, g = d.delay, d = d.duration), d && (d = (typeof d == "number" ? d :
                    a.fx.speeds[d] || a.fx.speeds._default) / 1e3), g && (g = parseFloat(g) / 1e3), this.anim(c, d,
                    e, f, g)
        }, a.fn.anim = function (c, d, e, f, g) {
            var h, i = {},
                v, w = "",
                x = this,
                y, z = a.fx.transitionEnd,
                A = !1;
            d === b && (d = a.fx.speeds._default / 1e3), g === b && (g = 0), a.fx.off && (d = 0);
            if (typeof c == "string") i[p] = c, i[q] = d + "s", i[s] = g + "s", i[r] = e || "linear", z = a.fx.animationEnd;
            else {
                v = [];
                for (h in c) j.test(h) ? w += h + "(" + c[h] + ") " : (i[h] = c[h], v.push(u(h)));
                w && (i[k] = w, v.push(k)), d > 0 && typeof c == "object" && (i[l] = v.join(", "), i[m] = d + "s",
                    i[o] = g + "s", i[n] = e || "linear")
            }
            return y = function (b) {
                ...
                if (A) return;
                y.call(x)
            }, d * 1e3 + 25)), this.size() && this.get(0).clientLeft, this.css(i), d <= 0 && setTimeout(
                function () {
                    x.each(function () {
                        y.call(this)
                    })
    ...
    function (a) {
        ...
        function l() {
            c && clearTimeout(c), d && clearTimeout(d), e && clearTimeout(e), f && clearTimeout(f), c = d = e = f =
                null, b = {}
        }
        ...
        a(document).ready(function () {
                var o, p, q = 0,
                    r = 0,
                    s, t;
                "MSGesture" in window && (h = new MSGesture, h.target = document.body), a(document).bind(
                    "MSGestureEnd",
                    function (a) {
                        var c = a.velocityX > 1 ? "Right" : a.velocityX < -1 ? "Left" : a.velocityY > 1 ?
                            "Down" : a.velocityY < -1 ? "Up" : null;
                        c && (b.el.trigger("swipe"), b.el.trigger("swipe" + c))
                    }).on("touchstart MSPointerDown pointerdown", function (d) {
                    if ((t = n(d, "down")) && !m(d)) return;
                    s = t ? d : d.touches[0], d.touches && d.touches.length === 1 && b.x2 && (b.x2 =
                            undefined, b.y2 = undefined), o = Date.now(), p = o - (b.last || o), b.el = a(
                            "tagName" in s.target ? s.target : s.target.parentNode), c && clearTimeout(c),
                        b.x1 = s.pageX, b.y1 = s.pageY, p > 0 && p <= 250 && (b.isDoubleTap = !0), b.last =
                        o, f = setTimeout(j, g), h && t && h.addPointer(d.pointerId)
                }).on("touchmove MSPointerMove pointermove", function (a) {
                    if ((t = n(a, "move")) && !m(a)) return;
                    s = t ? a : a.touches[0], k(), b.x2 = s.pageX, b.y2 = s.pageY, q += Math.abs(b.x1 - b.x2),
                        r += Math.abs(b.y1 - b.y2)
                }).on("touchend MSPointerUp pointerup", function (f) {
                    if ((t = n(f, "up")) && !m(f)) return;
                    k(), b.x2 && Math.abs(b.x1 - b.x2) > 30 || b.y2 && Math.abs(b.y1 - b.y2) > 30 ? e =
                        setTimeout(function () {
                            b.el.trigger("swipe"), b.el.trigger("swipe" + i(b.x1, b.x2, b.y1, b.y2)), b = {}
                        }, 0) : "last" in b && (q < 30 && r < 30 ? d = setTimeout(function () {
                            var d = a.Event("tap");
                            d.cancelTouch = l, b.el.trigger(d), b.isDoubleTap ? (b.el && b.el.trigger(
                                "doubleTap"), b = {}) : c = setTimeout(function () {
